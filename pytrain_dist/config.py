...
class GlobalConfig(Config):
    ...
    model_path: str = field(
        default="llama", metadata={"converter": str, "export": True}
    )
    nb_layer_freezed: int = field(
        default=0, metadata={"converter": int, "export": True}
    )
    peft: str | None = field(default=None, metadata={"converter": str, "export": True})
    training_dist: str | None = field(default=None, metadata={"converter": str, "export": True})
    ...
    step_per_epoch: int = field(default=100, metadata={"converter": int, "export": True})
    dataset_name: str = field(
        default="dataset", metadata={"converter": str, "export": True}
    )
    pad_token_id: int = field(default=151643, metadata={"converter": int, "export": True})
    seq_length: int = field(default=512, metadata={"converter": int, "export": True})
    batch_size: int = field(default=4, metadata={"converter": int, "export": True})
    smart_loading: bool = field(default=False, metadata={"converter": bool, "export": True})
